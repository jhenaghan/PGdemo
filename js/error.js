...
$('#error-button').on('click', function() {
 ...
 //   email = $('#inputEmail').val();
    ...
    var alertbox = `
	<div id="alert" class="alert alert-danger alert-dismissible fade show" role="alert" text-align: center>
		<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			<span aria-hidden="true">&times;</span>
		</button>
		<p style="color:red;font-size:28px;"><strong>We are currently experiencing an issue scanning receipts. Please wait a few minutes and try again.</strong></p>
	</div>
	`;
